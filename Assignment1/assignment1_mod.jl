...
"""
function buildBiofuelModel(data_file::String, waterFactor::Float64, areaFactor::Float64, petrolFactor::Float64, t1::Float64, t2::Float64, t3::Float64)
  include(data_file)
  # I: set of  crops
  # J: set of fuels
  ...
  # define the obj. fcn
  # define here to keep tax T as model input
  T = [t1, t2, t3]
